-- Rollback for migration 20260417110000_add_phantom_padding_support.sql
-- Restores previous dashboard RPC behavior and removes phantom-padding schema additions.
BEGIN;
...
DROP INDEX IF EXISTS public.idx_qa_temuan_is_phantom_padding;

ALTER TABLE public.qa_temuan
  DROP COLUMN IF EXISTS phantom_batch_id,
  DROP COLUMN IF EXISTS is_phantom_padding;
