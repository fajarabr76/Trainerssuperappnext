-- Exclude clean/perfect sessions from QA "total temuan" metrics while preserving
-- those rows for scoring and audit history.
...
BEGIN
  ...
  LOOP
    ...
    SELECT COUNT(*) FILTER (WHERE is_countable_finding), COUNT(DISTINCT peserta_id)
