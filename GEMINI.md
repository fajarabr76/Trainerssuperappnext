...
This document provides context and working instructions for AI assistants operating on the **Trainers SuperApp** codebase. It is aligned with `AGENTS.md` and should be treated as an equivalent operational guide.
