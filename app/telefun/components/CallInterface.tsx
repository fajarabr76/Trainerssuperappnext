  ...
  <div className="flex justify-center my-4 w-full">
    <div className="px-4 py-3 bg-red-500/10 border border-red-500/20 rounded-2xl flex items-center gap-3 max-w-lg">
      ...
      <p className="text-xs text-red-200/80 leading-relaxed">
        <strong className="text-red-400">Peringatan Penipuan:</strong> Konsumen mungkin mencoba memancing data pribadi atau melakukan penipuan. Tetap waspada dan jangan berikan informasi sensitif.
      </p>
    </div>
  </div>
);
