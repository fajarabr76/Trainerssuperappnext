        ...
        <div className="flex-1 overflow-y-auto p-10 space-y-6 custom-scrollbar">
          {history.length === 0 ? (
            <div className="py-20 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-xl font-black text-foreground/20 tracking-tight italic">Belum ada riwayat simulasi.</p>
                  ...
                  <div className="mt-8 pt-6 border-t border-border/50 flex items-center justify-between relative z-10">
                    <div className="flex gap-8">
                      <div className="space-y-1.5">
                        <div className="text-[9px] uppercase tracking-[0.2em] text-foreground/30 font-black">Konsumen</div>
                      ...
                      <div className="space-y-1.5">
                        <div className="text-[9px] uppercase tracking-[0.2em] text-foreground/30 font-black">Intensitas</div>
                        <div className="text-xs font-bold text-foreground flex items-center gap-2">
                           <div className="w-4 h-4 rounded-full bg-foreground/10 flex items-center justify-center text-[8px]">💬</div>
