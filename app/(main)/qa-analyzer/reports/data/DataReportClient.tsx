  ...
  return (
    <main className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="w-full border-b border-border/50 bg-card/20 p-4 backdrop-blur-sm lg:px-10 lg:py-6 overflow-y-auto max-h-[60vh] lg:max-h-none">
          <div className="flex items-center gap-2 mb-6 text-[10px] font-black uppercase tracking-widest text-muted-foreground">
            <Filter className="h-3 w-3" /> Konfigurasi Filter Laporan
          </div>

          <div className="flex flex-col gap-6">
            {/* Row 1: Primary Configuration & Target */}
            <div className="flex flex-wrap items-end gap-x-8 gap-y-4">
              {/* Group: Layanan & Mode */}
              <div className="flex items-end gap-4 border-r border-border/50 pr-8">
                <div className="w-40">
                  ...
                  <select
                    ...
                    className="h-10 w-full rounded-xl border border-border/50 bg-background px-3 text-xs font-bold outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                  >
                    {SERVICE_TYPES.map((s) => (
              ...
              <div className="flex-1 min-w-[240px]">
                ...
                >
                  <option value="ALL">Semua Parameter (Global Search)</option>
              ...
              {/* Group: Target (Tim & Agen) */}
              <div className="flex items-end gap-4 border-l border-border/50 pl-8">
                <div className="w-44">
                  <label className="mb-2 block text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                    Tim / Batch
                  </label>
                  <select
                    ...
                    className="h-10 w-full rounded-xl border border-border/50 bg-background px-3 text-xs font-bold outline-none focus:ring-2 focus:ring-primary/20"
                  >
            ...
            {/* Row 2: Temporal Configuration & Execution */}
            <div className="flex flex-wrap items-end justify-between gap-x-8 gap-y-4">
              <div className="flex flex-wrap items-end gap-x-8 gap-y-4">
                {/* Group: Tahun & Mode Periode */}
                <div className="flex items-end gap-4 border-r border-border/50 pr-8">
                  <div className="w-24">
                    <label className="mb-2 block text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                      Tahun
                ...
                <div className="flex items-end gap-4">
                  ...
                  {/* Audit Context Info */}
                  {mode === 'individu' && pesertaId && (
                    <div className="h-10 px-4 rounded-xl border border-dashed border-border bg-foreground/[0.02] flex items-center gap-3">
                      <div className="flex flex-col">
                        <span className="text-[8px] font-black uppercase tracking-widest text-muted-foreground leading-none mb-1">Status Audit Agent</span>
                        <div className="text-[10px] font-bold text-foreground/70 leading-none">
                          {loadingContext ? (
                            <span className="flex items-center gap-2">
                              <Loader2 className="w-2.5 h-2.5 animate-spin" /> Sinkronisasi...
                            </span>
                          ) : endMonth > 0 ? (
                            <span>Data Tersedia: Jan – {MONTHS[endMonth - 1]} {year}</span>
                          ) : (
                            <span className="text-amber-600">Belum ada audit di tahun {year}</span>
                          )}
                        </div>
                      </div>
                    </div>
              ...
              <button
                ...
                className="h-11 px-8 flex items-center justify-center gap-3 rounded-xl bg-foreground text-background font-black uppercase tracking-widest text-xs transition-all hover:scale-[1.02] active:scale-[0.98] hover:opacity-90 disabled:opacity-30 disabled:pointer-events-none shadow-xl shadow-foreground/10"
              >
        ...
        <section className="flex-1 overflow-hidden flex flex-col bg-background/50">
          <div className="flex-1 overflow-auto p-4 lg:p-10 lg:pt-8">
            {error && (
