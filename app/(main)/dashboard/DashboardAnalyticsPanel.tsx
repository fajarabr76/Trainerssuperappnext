...
export default function DashboardAnalyticsPanel({
  ...
  return (
    <>
      {(role?.toLowerCase() === 'trainer' || role?.toLowerCase() === 'trainers' || role?.toLowerCase() === 'leader' || role?.toLowerCase() === 'admin' || role?.toLowerCase() === 'superadmin') && (
      ...
      {(role?.toLowerCase() === 'trainer' || role?.toLowerCase() === 'trainers' || role?.toLowerCase() === 'admin' || role?.toLowerCase() === 'superadmin') && (
        <motion.div
