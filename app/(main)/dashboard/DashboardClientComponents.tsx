...
// Full DashboardTrendClient implementation
interface TrendData {
  labels: string[];
  totalData: number[];
...
export function DashboardTrendClient({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
      <div className="lg:col-span-2 rounded-3xl border border-border/40 bg-card/30 backdrop-blur-sm p-8 shadow-sm overflow-hidden">
      ...
      <div className="rounded-3xl border border-primary/20 bg-primary/95 text-primary-foreground p-6 flex flex-col shadow-2xl shadow-primary/10 relative overflow-hidden">
