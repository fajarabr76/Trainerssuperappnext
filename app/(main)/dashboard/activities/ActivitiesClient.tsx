              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-foreground/[0.02] border-b border-border">
                    <th className="px-8 py-6 font-black text-[10px] uppercase tracking-widest opacity-40">Waktu</th>
                    <th className="px-8 py-6 font-black text-[10px] uppercase tracking-widest opacity-40">User</th>
                    <th className="px-8 py-6 font-black text-[10px] uppercase tracking-widest opacity-40">Aktivitas</th>
                    <th className="px-8 py-6 font-black text-[10px] uppercase tracking-widest opacity-40">Modul</th>
                    <th className="px-8 py-6 font-black text-[10px] uppercase tracking-widest opacity-40">Tipe</th>
                    {isTrainer && <th className="px-8 py-6 font-black text-[10px] uppercase tracking-widest opacity-40 text-right">Aksi</th>}
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  {loading ? (
                    <tr>
                      <td colSpan={isTrainer ? 6 : 5} className="px-8 py-20 text-center">
                    ...
                    filteredLogs.map((log) => (
                      <tr key={log.id} className="hover:bg-foreground/[0.02] transition-colors group">
                        ...
                        <td className="px-8 py-6 text-sm font-bold tracking-tight text-foreground/80">{log.action}</td>
                        <td className="px-8 py-6">
